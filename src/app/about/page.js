...
const TEAM = [
  { name: "Батзориг Дөлгөөн",   role: "Үүсгэн байгуулагч & CEO",         initials: "БД" },
  { name: "Эрдэнэбилэг Шинэбилэг", role: "Брэндийн менежер",                initials: "ЭШ" },
  { name: "Манлайбаяр Мөнхжаргал",  role: "Арьс эмч, зөвлөх",               initials: "ММ" },
  { name: "Гантулга Сарнай",   role: "Бүтээгдэхүүн хариуцсан менежер", initials: "ГС" },
];
